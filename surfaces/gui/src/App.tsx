...
export function App() {
  ...
  const [surface, setSurface] = useState<
    "session" | "scheduled" | "integrations" | "audit" | "inbox" | "persona" | "settings" | "team"
  >("session");
    ...
    >
      ...
      {surface === "scheduled" ? (
        ...
        <TeamPage
          ...
          onManageCoworkers={() => openSettings("personas")}
        />
      ) : (
        ...
        <div className={"main-workspace" + (railHidden ? " rail-hidden" : "")}>
          <div className="main-chat">
            ...
            <Composer
              ...
              personas={idle && !sessionId.startsWith("__run__") ? personas : null}
              agent={agent}
              onPickCoworker={idle && !sessionId.startsWith("__run__") ? pickCoworker : undefined}
              onManageCoworkers={() => openSettings("personas")}
              onOpenTeam={() => setSurface("team")}
              onOpenConnectors={() => setSurface("integrations")}
