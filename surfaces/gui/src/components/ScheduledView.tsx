    ...
    <Shell>
      ...
      {empty ? (
        ...
        <div className="note-board">
          {tasks.map((task) => {
            const { color, rotate } = noteVariant(task.id);
            return (
              <div
                className={`note note-card sched-card ${color}`}
              ...
              >
                ...
                <div className="flex items-center gap-1.5 text-[12px] flex-wrap opacity-80">
...
function NewAutomationForm({
  ...
  return (
    <div className="note note-new note-yellow tmpl-form mb-4">
      <div className="note-new-label">
...
function TaskDetail({
  ...
  return (
    <Shell>
      ...
      <div className={"sched-detail note note-detail " + noteVariant(id).color}>
