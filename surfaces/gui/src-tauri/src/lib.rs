...
/// Native single-file picker (Team Setup U3): the "+" menu's Files/Folder attach routes a
/// single file through RAG ingestion, which needs a real filesystem path — same rationale as
/// pick_folder, mirrored for files instead of directories.
#[tauri::command]
