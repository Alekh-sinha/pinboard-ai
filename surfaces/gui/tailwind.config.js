  ...
  theme: {
    extend: {
      colors: {
        ...
        badgeBlueBg: tok("--badge-blue-bg"),
        badgeBlueFg: tok("--badge-blue-fg"),
        badgePurpleBg: tok("--badge-purple-bg"),
        badgePurpleFg: tok("--badge-purple-fg"),
        badgeGreenBg: tok("--badge-green-bg"),
        badgeGreenFg: tok("--badge-green-fg"),
        solid: tok("--solid"),
