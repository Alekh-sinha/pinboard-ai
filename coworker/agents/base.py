...
class Agent:
    ...
    # Built-in tool names to suppress despite being normally always-on (e.g. "web_search"
    # for a persona that brings its own MCP-backed search tools). See PersonaManifest.
