                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "model": {
                                "type": "string",
                                "description": (
                                    "Single-model shorthand. Ignored if `models` is given."
                                ),
                            },
                            "models": {
                                "type": "array",
                                "items": {"type": "string"},
                                "description": (
                                    "Ordered fallback pool — models[0] is what the worker "
                                    "starts on. If it hits a quota/access failure mid-task, "
                                    "the next entry is tried automatically before giving up."
                                ),
                            },
                            "reason": {"type": "string"},
                        },
